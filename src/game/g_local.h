...
typedef struct
{
  ...
  //Chat file in, Chat file out
  fileHandle_t			chatFileOut;
  fileHandle_t			chatFileIn;
...
extern  vmCvar_t  g_extremeSuddenDeathVotes;
extern  vmCvar_t  g_allowClientBlackNames;
