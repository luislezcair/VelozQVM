...
void Cmd_CallVote_f( gentity_t *ent )
{
  ...
  else
  {
    ...
    trap_SendServerCommand( ent-g_entities, "print \"Valid vote commands are: "
      "map, map_restart, nextmap, layout, draw, extend, kick, mute, unmute, poll, sudden_death (sd) and extreme_sudden_death (esd)\n" );
    return;
  }
...
void Cmd_Build_f( gentity_t *ent )
{
  ...
  if( g_extremeSuddenDeath.integer ) {
    trap_SendServerCommand( ent-g_entities, "print \"Building is not allowed during Extreme Sudden Death\n\"" );
    return;
  }
...
void Cmd_PTRCRestore_f( gentity_t *ent )
{
  ...
  {
    trap_SendServerCommand( ent - g_entities, "print \"You cannot use a PTR code after joining a team\n\"" );
    return;
  }
